...
const ROUTE = "/products/bottle-washing";
...
export default async function BottleWashingPage({ params }: PageProps) {
  const { locale } = await params;
  setRequestLocale(locale);
  return <SectorDetail locale={locale} routeSlug="bottle-washing" />;
}
